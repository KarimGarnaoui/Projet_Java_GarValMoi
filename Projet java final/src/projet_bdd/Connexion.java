...
public class Connexion {
     ...
     * @throws java.sql.SQLException
     */
    public String[][] remplirChampsRequete(String requete) throws SQLException {
        // récupération de l'ordre de la requete
        ...
        while (rset.next()) {
            ...
            //String champs;
           //li.add(rset.getString(1)); // ajouter premier champ
            // Concatener les champs de la ligne separes par ,
            for (int i = 0; i < nbColonne; i++) {
                li.add(rset.getString(i + 1));
            }
        ...
        String[][] tab = new String[liste.size()][nbColonne] ; 
    ...
    public ArrayList<String> remplirChampsRequeteArray(String requete) throws SQLException {
        // récupération de l'ordre de la requete
        rset = stmt.executeQuery(requete);
